...
def override_wbc_config(
    ...
    key_to_value = {
        ...
        "ISAAC_INTERNAL_STATE_TOPIC": config.isaac_internal_state_topic,
        "ISAAC_INTERNAL_COMMAND_TOPIC": config.isaac_internal_command_topic,
    }
...
class BaseConfig(ArgsConfigTemplate):
    ...
    isaac_internal_state_topic: str = ISAAC_INTERNAL_STATE_TOPIC
    """Internal state topic used by Isaac adapter and isaacsim processors."""

    isaac_internal_command_topic: str = ISAAC_INTERNAL_COMMAND_TOPIC
    """Internal command topic used by isaacsim command sender and adapter."""
