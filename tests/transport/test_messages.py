...
from systems.transport.codec import decode_message, encode_message
from systems.transport.messages import ActionCommand, ActionStatus, CapabilityReport, FrameHeader, HealthPing, RuntimeControlRequest, RuntimeNotice, TaskRequest
...
def test_ipc_message_roundtrip_encode_decode() -> None:
    samples = [
        ...
        TaskRequest(command_text="?꾧퉴 遊ㅻ뜕 ?ш낵瑜?李얠븘媛", target_json={"target_class": "apple"}),
