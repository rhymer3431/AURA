...
<video src="./media/object%20find.mp4" controls muted playsinline width="100%">
  <a href="./media/object%20find.mp4">object find demo video</a>
</video>

비디오가 렌더링되지 않으면 직접 열기: [media/object find.mp4](./media/object%20find.mp4)
