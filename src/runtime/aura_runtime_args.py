...
def add_subgoal_executor_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument("--use-navdp-follower", dest="use_navdp_follower", action="store_true")
    parser.add_argument("--no-use-navdp-follower", dest="use_navdp_follower", action="store_false")
    parser.set_defaults(use_navdp_follower=False)
