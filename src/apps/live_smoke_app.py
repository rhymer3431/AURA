...
from runtime.isaac_launch_modes import LAUNCH_MODE_AUTO, LAUNCH_MODE_ATTACH, LAUNCH_MODE_EXTENSION, LAUNCH_MODE_STANDALONE
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--launch-mode",
        choices=(LAUNCH_MODE_AUTO, LAUNCH_MODE_STANDALONE, LAUNCH_MODE_ATTACH, LAUNCH_MODE_EXTENSION),
