...
_EXPORTS = {
    ...
    "create_dashboard_backend_app": ("apps.dashboard_backend_app", "create_app"),
    "dashboard_backend_main": ("apps.dashboard_backend_app", "main"),
    "parse_dashboard_backend_args": ("apps.dashboard_backend_app", "parse_args"),
