...
from systems.planner.application.orchestration import (
...
from systems.planner.application.planner_service import PlannerService
from systems.planner.domain.reporting import (
    build_inspection_question,
    build_navigation_instruction,
    observed_value_from_answer,
    render_report_message,
)
from systems.planner.domain.validator import validate_task_frame_response
from systems.planner.infrastructure.llm_client import CompletionFn
    ...
    def check(
        ...
        if subgoal["type"] == "return":
            if bool(snapshot.get("return_pose_reached")) and zero_locomotion and stable_state:
                from systems.planner.domain.schemas import CompletionDecision
