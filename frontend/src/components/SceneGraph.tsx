...
import { type GraphData, type LinkData, type NodeData } from "../domain/types/GraphTypes";
...
export function SceneGraph() {
  ...
  const colorFn = (node: NodeData) => {
    ...
    if (node.group === 2) return "#cfcfcfff";
    return STATIC_COLOR;
  };
      ...
      <div className="grid h-full min-h-0 grid-cols-[1fr_450px] gap-6">
        ...
        <div className="panel">
          ...
          <div className="flex-1 min-h-0">
            <div
              ref={containerRef}
              className="relative w-full h-full min-h-0 overflow-hidden rounded-lg bg-gradient-to-br from-gray-50 to-gray-100"
            >
              <ForcedGraph
                data={graphData}
