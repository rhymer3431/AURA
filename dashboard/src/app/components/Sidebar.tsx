  ...
  return (
    <aside className="dashboard-sidebar" data-open={isMobileOpen ? "true" : "false"}>
      <div className="relative px-4 pb-3 pt-4 lg:px-5 lg:pb-4 lg:pt-5">
        <div className="flex items-center justify-between rounded-[20px] border border-[rgba(17,23,28,0.08)] bg-[rgba(255,255,255,0.72)] px-3 py-3">
          <div className="flex items-center gap-3">
            <div className="inline-flex size-8 shrink-0 items-center justify-center rounded-[12px] border border-[rgba(17,23,28,0.08)] bg-[rgba(17,23,28,0.96)] text-white">
          ...
          <div className="inline-flex items-center gap-1 rounded-full border border-[rgba(17,23,28,0.08)] bg-[rgba(17,23,28,0.04)] px-2.5 py-1 text-[11px] text-[var(--text-secondary)]">
                ...
                {section.items.map((item) => (
                  <button
                    ...
                    className={`relative flex w-full items-center gap-3 rounded-[16px] px-3 py-2.5 text-left transition-colors ${
                      activePage === item.id
                        ? "border border-[rgba(17,23,28,0.06)] bg-[rgba(17,23,28,0.05)] text-[var(--foreground)]"
                        : "text-[var(--text-secondary)] hover:bg-[rgba(17,23,28,0.03)]"
                    }`}
                  >
                    <div
                      className={`flex size-8 items-center justify-center rounded-[12px] ${
                        activePage === item.id
                          ? "bg-[rgba(17,23,28,0.08)] text-[var(--foreground)]"
      ...
      <div className="mt-auto hidden border-t border-[rgba(17,23,28,0.06)] p-5 lg:block">
        <div className="rounded-[18px] border border-[rgba(17,23,28,0.08)] bg-[rgba(255,255,255,0.7)] px-4 py-3">
