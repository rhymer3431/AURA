    ...
    >
      ...
      >
        ...
        <div className="space-y-3">
          {logs.length === 0 ? (
            <div className="rounded-[18px] bg-[var(--surface-2)] px-4 py-4 text-[12px] text-[var(--text-tertiary)]">
      ...
      >
        ...
        <div className="rounded-[18px] bg-[var(--tone-violet-bg)] px-4 py-4">
      ...
      >
        ...
        <div className="space-y-2.5">
          {watchlist.length === 0 ? (
            <div className="dashboard-rail-item text-[12px] text-[var(--text-tertiary)]">
